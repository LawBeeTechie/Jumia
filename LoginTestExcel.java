...
public class LoginTestExcel { // Performing Data driven test with Iteration
	...
	@Test(description = "verify if login api works for from desk and returns 200 status code with message as success", groups = {"e2e", "smoke",
			"sanity"}, priority = 1, dataProviderClass = com.dataprovider.LoginExcelDataProvider.class, dataProvider= "loginDP2" )//, retryAnalyzer = com.utils.MyRetryAnalyzer.class)
